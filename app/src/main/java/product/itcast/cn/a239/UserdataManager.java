...
//    public static final String VIBRATE = "vibrate";
    ...
    public Userdata find(String userName) {
        ...
        Cursor cursor = db.rawQuery("select user_name,user_pwd from users where user_name=?", new String[] { userName });

        if (cursor.moveToNext()) {
            return new Userdata(cursor.getString(cursor.getColumnIndex("user_name")),
